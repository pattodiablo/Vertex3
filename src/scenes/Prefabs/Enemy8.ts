...
export default class Enemy8 extends EnemyBase {

	constructor(scene: Phaser.Scene, x?: number, y?: number, texture?: string, frame?: number | string) {
		super(scene, x ?? 0, y ?? 0, texture || "enemy8", frame);
		...
		const shape = b2CreatePolygonShape(body, { 
			...b2DefaultShapeDef()
		}, b2MakePolygon(b2ComputeHull([new b2Vec2(pxm(-27), pxm(-31.5)), new b2Vec2(pxm(27), pxm(-31.5)), new b2Vec2(pxm(27), pxm(31.5)), new b2Vec2(pxm(-27), pxm(31.5))], 4), pxm(0)));
